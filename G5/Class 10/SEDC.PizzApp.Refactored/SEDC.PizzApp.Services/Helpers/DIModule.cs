...
namespace SEDC.PizzApp.Services.Helpers
{
   public static class DIModule
   {
      ...
      {
         // "Server=localhost\\SQLExpress;Database=PizzaDb;Trusted_Connection=True" -> SQLExpress users
         // "Server=localhost;Database=PizzaDb;Trusted_Connection=True" -> SQLServer users
